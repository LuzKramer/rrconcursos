        ...
        <div class="question">
            ...
            while ($resultado = mysqli_fetch_assoc($query_questao)) { //Enquanto tiver as questões...
                ...
                if ($id_questao = $loucura) {
                    if (in_array($id_questao, $idd, true)) {
                        ...
                        // echclass="filtro"o "<h1>Sem questões</h1>";
            ...
            ?>
                    ...
                    <?php
                        ...
                        echo '<ul style="margin: 6px; display: flex; flex-direction: row; justify-content: space-between;"><li>Matéria: ' . $disciplina_questao . '</li><li>Ano: ' . $ano_questao . '</li><li>Instituição: ' . $institui . '</li></ul>';
                        ...
                        echo "<h1 style='font-size:20px;'>" . $enunciado . '</h1><br>';
